...
class OsloEnumerationValues(models.Model):
    ...
    _description = """
    awv OSLOEnumeration Values table is generated by retrieving the 'keuzeslijst' value on the repository of Informatie 
    Vlanderen since these are not provided with the SQLite db."""
